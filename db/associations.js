module.exports = {
  associate: (models) => {
    ...
    models.Contractor.belongsTo(models.Contractor_Status, {
      foreignKey: 'contractorStatusID',
    })
    models.Contractor_Status.hasMany(models.Contractor, {
      foreignKey: 'contractorStatusID',
    })
    ...
    models.Assigned_Clinic_Area.belongsTo(models.Contractor, {
      foreignKey: 'contractorID',
    })
    models.Assigned_Clinic_Area.belongsTo(models.Clinic_Area, {
      foreignKey: 'clinicID',
    })
    ...
    models.Project.belongsTo(models.Project_Status, {
      foreignKey: 'projectStatusID',
    })

    models.Contractor_Project.belongsTo(models.Project, {
    ...
    models.Assigned_Module.belongsTo(models.Module, { foreignKey: 'moduleID' })
    models.Assigned_Module.belongsTo(models.Contractor, {
      foreignKey: 'contractorID',
    })
    models.Assigned_Module.belongsTo(models.Project, {
      foreignKey: 'projectID',
    })
    ...
    models.Contractor_Flight.belongsTo(models.Contractor, {
      foreignKey: 'contractorID',
    })
    models.Contractor_Flight.belongsTo(models.Flight, {
      foreignKey: 'flightID',
    })

    models.Contractor_Hotel.belongsTo(models.Contractor, {
      foreignKey: 'contractorID',
    })
    models.Contractor_Hotel.belongsTo(models.Hotel, {
      foreignKey: 'hotelID',
    })
